...
# TZ: I thought it was really interesting that you attempted to create a loop that should run 10000 times but can only run to the length of titis_calls which is 30.
# I also do agree that when you were creating the barplot that it didn't run properly because sim is a vector of mean instead of probabilities.
...
# TZ: I also ended up with similar graphs with similar distributions as well!
...
# TZ: I think your code displays a great understanding of dpois(), ppois(), and rpois() as I also didn't understand it as well.
# It also helped me understand how to use the cayman package as well. Overall, this code was clear and concise.